...
-- Copiando estrutura para tabela acadlite.agrupamento_mensalidade
CREATE TABLE IF NOT EXISTS `agrupamento_mensalidade` (
...
-- Copiando dados para a tabela acadlite.agrupamento_mensalidade: ~19 rows (aproximadamente)
DELETE FROM `agrupamento_mensalidade`;
/*!40000 ALTER TABLE `agrupamento_mensalidade` DISABLE KEYS */;
INSERT INTO `agrupamento_mensalidade` (`cod_agrupamento`, `dt_operacao`) VALUES
	(1, '2016-05-13 10:59:12'),
	(2, '2016-05-13 11:02:51'),
	(3, '2016-05-13 12:58:26'),
	(4, '2016-05-13 13:32:44'),
	(5, '2016-05-13 13:38:24'),
	(6, '2016-05-13 13:51:38'),
	(7, '2016-05-13 13:53:25'),
	(8, '2016-05-13 15:25:07'),
	(9, '2016-05-13 15:30:48'),
	(10, '2016-05-13 15:33:49'),
	(11, '2016-05-13 15:36:36'),
	(12, '2016-05-13 15:39:50'),
	(13, '2016-05-13 15:48:40'),
	(14, '2016-05-13 15:49:42'),
	(15, '2016-05-13 15:51:42'),
	(16, '2016-05-13 15:54:57'),
	(17, '2016-05-13 22:31:14'),
	(18, '2016-05-13 22:33:13'),
	(19, '2016-05-13 23:07:50'),
	(20, '2016-05-14 00:24:55'),
	(21, '2016-05-14 00:25:23'),
	(22, '2016-05-14 00:25:48');
/*!40000 ALTER TABLE `agrupamento_mensalidade` ENABLE KEYS */;


-- Copiando estrutura para tabela acadlite.cidade
...
-- Copiando dados para a tabela acadlite.cidade: ~5.564 rows (aproximadamente)
DELETE FROM `cidade`;
...
-- Copiando estrutura para tabela acadlite.estado
...
-- Copiando dados para a tabela acadlite.estado: ~27 rows (aproximadamente)
DELETE FROM `estado`;
...
-- Copiando estrutura para tabela acadlite.formas_pagamento
...
-- Copiando dados para a tabela acadlite.formas_pagamento: ~5 rows (aproximadamente)
...
-- Copiando dados para a tabela acadlite.lancamentos: ~304 rows (aproximadamente)
...
INSERT INTO `lancamentos` (`cod_lanc`, `descricao`, `dt_lanc`, `dt_vencimento`, `cod_tipo_lanc`, `dt_exclusao`, `valor`, `cod_mensalidade`, `fixo`) VALUES
	...
	(121, 'hoje', '2016-05-11 16:51:49', '2016-05-12', 7, NULL, 40, 106, 'N'),
	(122, 'bicicretinha', '2016-05-13 13:30:40', '2016-10-14', 7, NULL, 120, 148, 'N'),
	(123, 'Ditin', '2016-05-13 13:33:20', '2017-12-10', 7, NULL, 120, 158, 'N'),
	(124, 'Ditin', '2016-05-13 13:33:20', '2018-01-10', 7, NULL, 120, 158, 'N'),
	(125, 'Ditin', '2016-05-13 13:33:21', '2018-02-10', 7, NULL, 120, 158, 'N'),
	(126, 'Ditin', '2016-05-13 13:33:21', '2018-03-10', 7, NULL, 120, 158, 'N'),
	(127, 'Ditin', '2016-05-13 13:33:21', '2018-04-10', 7, NULL, 120, 158, 'N'),
	(128, 'Ditin', '2016-05-13 13:33:21', '2018-05-10', 7, NULL, 120, 158, 'N'),
	(129, 'Ditin', '2016-05-13 13:33:21', '2018-07-10', 7, NULL, 120, 158, 'N'),
	(130, 'agnaldo', '2016-05-13 13:39:03', '2016-05-16', 7, NULL, 120, 166, 'N'),
	(131, 'agnaldo', '2016-05-13 13:39:03', '2016-06-16', 7, NULL, 120, 166, 'N'),
	(132, 'agnaldo', '2016-05-13 13:39:03', '2016-07-16', 7, NULL, 120, 166, 'N'),
	(133, 'agnaldo', '2016-05-13 13:39:03', '2016-08-16', 7, NULL, 120, 166, 'N'),
	(134, 'agnaldo', '2016-05-13 13:39:04', '2016-09-16', 7, NULL, 120, 166, 'N'),
	(135, 'agnaldo', '2016-05-13 13:39:04', '2016-10-16', 7, NULL, 120, 166, 'N'),
	(136, 'agnaldo', '2016-05-13 13:39:04', '2016-11-16', 7, NULL, 120, 166, 'N'),
	(137, 'agnaldo', '2016-05-13 13:39:04', '2016-12-16', 7, NULL, 120, 166, 'N'),
	(138, 'timoteo', '2016-05-13 13:52:43', '2017-01-10', 7, NULL, 120, 173, 'N'),
	(139, 'timoteo', '2016-05-13 13:52:43', '2017-02-10', 7, NULL, 120, 173, 'N'),
	(140, 'timoteo', '2016-05-13 13:52:43', '2017-03-10', 7, NULL, 120, 173, 'N'),
	(141, 'timoteo', '2016-05-13 13:52:43', '2017-04-10', 7, NULL, 120, 173, 'N'),
	(142, 'timoteo', '2016-05-13 13:52:43', '2017-05-10', 7, NULL, 120, 173, 'N'),
	(143, 'timoteo', '2016-05-13 13:52:43', '2017-06-10', 7, NULL, 120, 173, 'N'),
	(144, 'timoteo', '2016-05-13 13:52:43', '2017-07-10', 7, NULL, 120, 173, 'N'),
	(145, 'timoteo', '2016-05-13 13:52:43', '2017-08-10', 7, NULL, 120, 173, 'N'),
	(146, 'patricia', '2016-05-13 13:54:10', '2017-01-14', 7, NULL, 15, 182, 'N'),
	(147, 'patricia', '2016-05-13 13:54:10', '2017-02-14', 7, NULL, 15, 182, 'N'),
	(148, 'patricia', '2016-05-13 13:54:10', '2017-03-14', 7, NULL, 15, 182, 'N'),
	(149, 'patricia', '2016-05-13 13:54:10', '2017-04-14', 7, NULL, 15, 182, 'N'),
	(150, 'patricia', '2016-05-13 13:54:10', '2017-05-14', 7, NULL, 15, 182, 'N'),
	(151, 'patricia', '2016-05-13 13:54:10', '2017-06-14', 7, NULL, 15, 182, 'N'),
	(152, 'patricia', '2016-05-13 13:54:10', '2017-07-14', 7, NULL, 15, 182, 'N'),
	(153, 'patricia', '2016-05-13 13:54:10', '2017-08-14', 7, NULL, 15, 182, 'N'),
	(154, 'agrupado', '2016-05-13 15:26:24', '2017-08-13', 7, NULL, 120, 186, 'N'),
	(155, 'agrupado', '2016-05-13 15:27:54', '2017-07-13', 7, NULL, 120, 185, 'N'),
	(156, 'agrupado', '2016-05-13 15:28:22', '2017-09-13', 7, NULL, 210, 187, 'N'),
	(157, 'agrupado', '2016-05-13 15:28:43', '2017-06-13', 7, NULL, 120, 190, 'N'),
	(158, 'agrupado', '2016-05-13 15:28:43', '2017-10-13', 7, NULL, 120, 190, 'N'),
	(159, 'agrupado', '2016-05-13 15:28:44', '2017-11-13', 7, NULL, 120, 190, 'N'),
	(160, 'agrupado', '2016-05-13 15:28:44', '2017-12-13', 7, NULL, 120, 190, 'N'),
	(161, 'agrupado', '2016-05-13 15:28:44', '2018-01-13', 7, NULL, 120, 190, 'N'),
	(162, 'naldo', '2016-05-13 15:31:56', '2017-06-14', 7, NULL, 100, 199, 'N'),
	(163, 'naldo', '2016-05-13 15:31:56', '2017-07-14', 7, NULL, 100, 199, 'N'),
	(164, 'naldo', '2016-05-13 15:31:56', '2017-08-14', 7, NULL, 100, 199, 'N'),
	(165, 'naldo', '2016-05-13 15:31:56', '2017-09-14', 7, NULL, 100, 199, 'N'),
	(166, 'naldo', '2016-05-13 15:31:56', '2017-10-14', 7, NULL, 100, 199, 'N'),
	(167, 'naldo', '2016-05-13 15:31:56', '2017-11-14', 7, NULL, 100, 199, 'N'),
	(168, 'naldo', '2016-05-13 15:31:57', '2017-12-14', 7, NULL, 100, 199, 'N'),
	(169, 'naldo', '2016-05-13 15:31:57', '2018-01-14', 7, NULL, 100, 199, 'N'),
	(170, 'novo', '2016-05-13 15:34:12', '2016-12-10', 7, NULL, 110, 200, 'N'),
	(171, 'novo', '2016-05-13 15:34:12', '2017-01-10', 7, NULL, 110, 200, 'N'),
	(172, 'novo', '2016-05-13 15:34:12', '2017-02-10', 7, NULL, 110, 200, 'N'),
	(173, 'novo', '2016-05-13 15:34:13', '2017-03-10', 7, NULL, 110, 200, 'N'),
	(174, 'novo', '2016-05-13 15:34:13', '2017-04-10', 7, NULL, 110, 200, 'N'),
	(175, 'novo', '2016-05-13 15:34:13', '2017-05-10', 7, NULL, 110, 200, 'N'),
	(176, 'novo', '2016-05-13 15:34:13', '2017-06-10', 7, NULL, 110, 200, 'N'),
	(177, 'novo', '2016-05-13 15:34:13', '2017-07-10', 7, NULL, 110, 200, 'N'),
	(178, 'bagulho', '2016-05-13 15:37:11', '2017-05-13', 7, NULL, 120, 208, 'N'),
	(179, 'bagulho', '2016-05-13 15:37:11', '2017-06-13', 7, NULL, 120, 208, 'N'),
	(180, 'bagulho', '2016-05-13 15:37:11', '2017-07-13', 7, NULL, 120, 208, 'N'),
	(181, 'bagulho', '2016-05-13 15:37:11', '2017-08-13', 7, NULL, 120, 208, 'N'),
	(182, 'bagulho', '2016-05-13 15:37:11', '2017-09-13', 7, NULL, 120, 208, 'N'),
	(183, 'bagulho', '2016-05-13 15:37:11', '2017-10-13', 7, NULL, 120, 208, 'N'),
	(184, 'bagulho', '2016-05-13 15:37:11', '2017-11-13', 7, NULL, 120, 208, 'N'),
	(185, 'bagulho', '2016-05-13 15:37:11', '2017-12-13', 7, NULL, 120, 208, 'N'),
	(186, 'loucura', '2016-05-13 15:40:13', '2016-12-10', 7, NULL, 120, 217, 'N'),
	(187, 'loucura', '2016-05-13 15:40:13', '2017-01-10', 7, NULL, 120, 217, 'N'),
	(188, 'loucura', '2016-05-13 15:40:13', '2017-02-10', 7, NULL, 120, 217, 'N'),
	(189, 'loucura', '2016-05-13 15:40:13', '2017-03-10', 7, NULL, 120, 217, 'N'),
	(190, 'loucura', '2016-05-13 15:40:13', '2017-04-10', 7, NULL, 120, 217, 'N'),
	(191, 'loucura', '2016-05-13 15:40:13', '2017-05-10', 7, NULL, 120, 217, 'N'),
	(192, 'loucura', '2016-05-13 15:40:13', '2017-06-10', 7, NULL, 120, 217, 'N'),
	(193, 'loucura', '2016-05-13 15:40:13', '2017-07-10', 7, NULL, 120, 217, 'N'),
	(194, 'Alegria', '2016-05-13 15:52:57', '2019-01-10', 7, NULL, 210, 233, 'N'),
	(195, 'Alegria', '2016-05-13 15:53:20', '2019-02-10', 7, NULL, 200, 234, 'N'),
	(196, 'Alegria', '2016-05-13 15:53:21', '2019-03-10', 7, NULL, 200, 234, 'N'),
	(197, 'Alegria', '2016-05-13 15:53:21', '2019-04-10', 7, NULL, 200, 234, 'N'),
	(198, 'Alegria', '2016-05-13 15:53:21', '2019-05-10', 7, NULL, 200, 234, 'N'),
	(199, 'Alegria', '2016-05-13 15:53:21', '2019-06-10', 7, NULL, 200, 234, 'N'),
	(200, 'Alegria', '2016-05-13 15:53:21', '2019-07-10', 7, NULL, 200, 234, 'N'),
	(201, 'Alegria', '2016-05-13 15:53:21', '2019-08-10', 7, NULL, 200, 234, 'N'),
	(202, 'infinito', '2016-05-13 15:55:36', '2017-10-10', 7, NULL, 10, 241, 'N'),
	(203, 'infinito', '2016-05-13 15:55:36', '2017-11-10', 7, NULL, 10, 241, 'N'),
	(204, 'infinito', '2016-05-13 15:55:36', '2017-12-10', 7, NULL, 10, 241, 'N'),
	(205, 'infinito', '2016-05-13 15:55:37', '2018-01-10', 7, NULL, 10, 241, 'N'),
	(206, 'infinito', '2016-05-13 15:55:37', '2018-02-10', 7, NULL, 10, 241, 'N'),
	(207, 'infinito', '2016-05-13 15:55:37', '2018-03-10', 7, NULL, 10, 241, 'N'),
	(208, 'infinito', '2016-05-13 15:55:37', '2018-04-10', 7, NULL, 10, 241, 'N'),
	(209, 'infinito', '2016-05-13 15:55:37', '2018-05-10', 7, NULL, 10, 241, 'N'),
	(210, 'infinito', '2016-05-13 15:55:37', '2018-06-10', 7, NULL, 10, 241, 'N'),
	(211, 'infinito', '2016-05-13 15:55:37', '2018-07-10', 7, NULL, 10, 241, 'N'),
	(212, 'infinito', '2016-05-13 15:55:37', '2018-08-10', 7, NULL, 10, 241, 'N'),
	(213, 'infinito', '2016-05-13 15:55:37', '2018-09-10', 7, NULL, 10, 241, 'N'),
	(214, 'infinito', '2016-05-13 15:55:37', '2018-10-10', 7, NULL, 10, 241, 'N'),
	(215, 'infinito', '2016-05-13 15:55:37', '2018-11-10', 7, NULL, 10, 241, 'N'),
	(216, 'infinito', '2016-05-13 15:55:37', '2018-12-10', 7, NULL, 10, 241, 'N'),
	(217, 'infinito', '2016-05-13 15:55:37', '2019-01-10', 7, NULL, 10, 241, 'N'),
	(218, 'infinito', '2016-05-13 15:55:37', '2019-02-10', 7, NULL, 10, 241, 'N'),
	(219, 'infinito', '2016-05-13 15:55:37', '2019-03-10', 7, NULL, 10, 241, 'N'),
	(220, 'infinito', '2016-05-13 15:55:37', '2019-04-10', 7, NULL, 10, 241, 'N'),
	(221, 'infinito', '2016-05-13 15:55:37', '2019-05-10', 7, NULL, 10, 241, 'N'),
	(222, 'infinito', '2016-05-13 15:55:37', '2019-06-10', 7, NULL, 10, 241, 'N'),
	(223, 'infinito', '2016-05-13 15:55:37', '2019-07-10', 7, NULL, 10, 241, 'N'),
	(224, 'infinito', '2016-05-13 15:55:38', '2019-08-10', 7, NULL, 10, 241, 'N'),
	(225, 'infinito', '2016-05-13 15:55:38', '2019-09-10', 7, NULL, 10, 241, 'N'),
	(226, 'infinito', '2016-05-13 15:55:38', '2019-10-10', 7, NULL, 10, 241, 'N'),
	(227, 'infinito', '2016-05-13 15:55:38', '2019-11-10', 7, NULL, 10, 241, 'N'),
	(228, 'infinito', '2016-05-13 15:55:38', '2019-12-10', 7, NULL, 10, 241, 'N'),
	(229, 'infinito', '2016-05-13 15:55:38', '2020-01-10', 7, NULL, 10, 241, 'N'),
	(230, 'infinito', '2016-05-13 15:55:38', '2020-02-10', 7, NULL, 10, 241, 'N'),
	(231, 'infinito', '2016-05-13 15:55:38', '2020-03-10', 7, NULL, 10, 241, 'N'),
	(232, 'infinito', '2016-05-13 15:55:38', '2020-04-10', 7, NULL, 10, 241, 'N'),
	(233, 'infinito', '2016-05-13 15:55:38', '2020-05-10', 7, NULL, 10, 241, 'N'),
	(234, 'infinito', '2016-05-13 15:55:38', '2020-06-10', 7, NULL, 10, 241, 'N'),
	(235, 'infinito', '2016-05-13 15:55:38', '2020-07-10', 7, NULL, 10, 241, 'N'),
	(236, 'infinito', '2016-05-13 15:55:38', '2020-08-10', 7, NULL, 10, 241, 'N'),
	(237, 'infinito', '2016-05-13 15:55:38', '2020-09-10', 7, NULL, 10, 241, 'N'),
	(238, 'infinito', '2016-05-13 15:55:38', '2020-10-10', 7, NULL, 10, 241, 'N'),
	(239, 'infinito', '2016-05-13 15:55:38', '2020-11-10', 7, NULL, 10, 241, 'N'),
	(240, 'infinito', '2016-05-13 15:55:38', '2020-12-10', 7, NULL, 10, 241, 'N'),
	(241, 'infinito', '2016-05-13 15:55:38', '2021-01-10', 7, NULL, 10, 241, 'N'),
	(242, 'infinito', '2016-05-13 15:55:39', '2021-02-10', 7, NULL, 10, 241, 'N'),
	(243, 'infinito', '2016-05-13 15:55:39', '2021-03-10', 7, NULL, 10, 241, 'N'),
	(244, 'infinito', '2016-05-13 15:55:39', '2021-04-10', 7, NULL, 10, 241, 'N'),
	(245, 'infinito', '2016-05-13 15:55:39', '2021-05-10', 7, NULL, 10, 241, 'N'),
	(246, 'infinito', '2016-05-13 15:55:39', '2021-06-10', 7, NULL, 10, 241, 'N'),
	(247, 'infinito', '2016-05-13 15:55:39', '2021-07-10', 7, NULL, 10, 241, 'N'),
	(248, 'infinito', '2016-05-13 15:55:39', '2021-08-10', 7, NULL, 10, 241, 'N'),
	(249, 'infinito', '2016-05-13 15:55:39', '2021-09-10', 7, NULL, 10, 241, 'N'),
	(250, 'infinito', '2016-05-13 15:55:39', '2021-10-10', 7, NULL, 10, 241, 'N'),
	(251, 'infinito', '2016-05-13 15:55:39', '2021-11-10', 7, NULL, 10, 241, 'N'),
	(252, 'infinito', '2016-05-13 15:55:39', '2021-12-10', 7, NULL, 10, 241, 'N'),
	(253, 'infinito', '2016-05-13 15:55:39', '2022-01-10', 7, NULL, 10, 241, 'N'),
	(254, 'infinito', '2016-05-13 15:55:39', '2022-02-10', 7, NULL, 10, 241, 'N'),
	(255, 'infinito', '2016-05-13 15:55:39', '2022-03-10', 7, NULL, 10, 241, 'N'),
	(256, 'infinito', '2016-05-13 15:55:39', '2022-04-10', 7, NULL, 10, 241, 'N'),
	(257, 'infinito', '2016-05-13 15:55:39', '2022-05-10', 7, NULL, 10, 241, 'N'),
	(258, 'infinito', '2016-05-13 15:55:39', '2022-06-10', 7, NULL, 10, 241, 'N'),
	(259, 'infinito', '2016-05-13 15:55:39', '2022-07-10', 7, NULL, 10, 241, 'N'),
	(260, 'infinito', '2016-05-13 15:55:40', '2022-08-10', 7, NULL, 10, 241, 'N'),
	(261, 'infinito', '2016-05-13 15:55:40', '2022-09-10', 7, NULL, 10, 241, 'N'),
	(262, 'infinito', '2016-05-13 15:55:40', '2022-10-10', 7, NULL, 10, 241, 'N'),
	(263, 'infinito', '2016-05-13 15:55:40', '2022-11-10', 7, NULL, 10, 241, 'N'),
	(264, 'infinito', '2016-05-13 15:55:40', '2022-12-10', 7, NULL, 10, 241, 'N'),
	(265, 'infinito', '2016-05-13 15:55:40', '2023-01-10', 7, NULL, 10, 241, 'N'),
	(266, 'infinito', '2016-05-13 15:55:40', '2023-02-10', 7, NULL, 10, 241, 'N'),
	(267, 'infinito', '2016-05-13 15:55:40', '2023-03-10', 7, NULL, 10, 241, 'N'),
	(268, 'infinito', '2016-05-13 15:55:40', '2023-04-10', 7, NULL, 10, 241, 'N'),
	(269, 'infinito', '2016-05-13 15:55:40', '2023-05-10', 7, NULL, 10, 241, 'N'),
	(270, 'infinito', '2016-05-13 15:55:40', '2023-06-10', 7, NULL, 10, 241, 'N'),
	(271, 'infinito', '2016-05-13 15:55:40', '2023-07-10', 7, NULL, 10, 241, 'N'),
	(272, 'infinito', '2016-05-13 15:55:40', '2023-08-10', 7, NULL, 10, 241, 'N'),
	(273, 'infinito', '2016-05-13 15:55:40', '2023-09-10', 7, NULL, 10, 241, 'N'),
	(274, 'infinito', '2016-05-13 15:55:40', '2023-10-10', 7, NULL, 10, 241, 'N'),
	(275, 'infinito', '2016-05-13 15:55:40', '2023-11-10', 7, NULL, 10, 241, 'N'),
	(276, 'infinito', '2016-05-13 15:55:40', '2023-12-10', 7, NULL, 10, 241, 'N'),
	(277, 'infinito', '2016-05-13 15:55:40', '2024-01-10', 7, NULL, 10, 241, 'N'),
	(278, 'infinito', '2016-05-13 15:55:40', '2024-02-10', 7, NULL, 10, 241, 'N'),
	(279, 'infinito', '2016-05-13 15:55:40', '2024-03-10', 7, NULL, 10, 241, 'N'),
	(280, 'infinito', '2016-05-13 15:55:41', '2024-04-10', 7, NULL, 10, 241, 'N'),
	(281, 'infinito', '2016-05-13 15:55:41', '2024-05-10', 7, NULL, 10, 241, 'N'),
	(282, 'infinito', '2016-05-13 15:55:41', '2024-06-10', 7, NULL, 10, 241, 'N'),
	(283, 'infinito', '2016-05-13 15:55:41', '2024-07-10', 7, NULL, 10, 241, 'N'),
	(284, 'infinito', '2016-05-13 15:55:41', '2024-08-10', 7, NULL, 10, 241, 'N'),
	(285, 'infinito', '2016-05-13 15:55:41', '2024-09-10', 7, NULL, 10, 241, 'N'),
	(286, 'infinito', '2016-05-13 15:55:41', '2024-10-10', 7, NULL, 10, 241, 'N'),
	(287, 'infinito', '2016-05-13 15:55:41', '2024-11-10', 7, NULL, 10, 241, 'N'),
	(288, 'infinito', '2016-05-13 15:55:41', '2024-12-10', 7, NULL, 10, 241, 'N'),
	(289, 'infinito', '2016-05-13 15:55:41', '2025-01-10', 7, NULL, 10, 241, 'N'),
	(290, 'infinito', '2016-05-13 15:55:41', '2025-02-10', 7, NULL, 10, 241, 'N'),
	(291, 'infinito', '2016-05-13 15:55:41', '2025-03-10', 7, NULL, 10, 241, 'N'),
	(292, 'infinito', '2016-05-13 15:55:41', '2025-04-10', 7, NULL, 10, 241, 'N'),
	(293, 'infinito', '2016-05-13 15:55:41', '2025-05-10', 7, NULL, 10, 241, 'N'),
	(294, 'infinito', '2016-05-13 15:55:41', '2025-06-10', 7, NULL, 10, 241, 'N'),
	(295, 'infinito', '2016-05-13 15:55:41', '2025-07-10', 7, NULL, 10, 241, 'N'),
	(296, 'infinito', '2016-05-13 15:55:41', '2025-08-10', 7, NULL, 10, 241, 'N'),
	(297, 'infinito', '2016-05-13 15:55:41', '2025-09-10', 7, NULL, 10, 241, 'N'),
	(298, 'infinito', '2016-05-13 15:55:41', '2025-10-10', 7, NULL, 10, 241, 'N'),
	(299, 'infinito', '2016-05-13 15:55:42', '2025-11-10', 7, NULL, 10, 241, 'N'),
	(300, 'Mensalidade comum', '2016-05-13 23:04:00', '2016-11-10', 7, NULL, 100, 52, 'N'),
	(301, 'naldinho', '2016-05-13 23:14:45', '2019-07-01', 7, NULL, 120, 136, 'N'),
	(302, 'naldinho', '2016-05-13 23:14:45', '2019-08-01', 7, NULL, 120, 136, 'N'),
	(303, 'naldinho', '2016-05-13 23:14:45', '2019-09-01', 7, NULL, 120, 136, 'N'),
	(304, 'naldinho', '2016-05-13 23:14:45', '2019-10-01', 7, NULL, 120, 136, 'N'),
	(305, 'naldinho', '2016-05-13 23:14:45', '2019-11-01', 7, NULL, 120, 136, 'N'),
	(306, 'naldinho', '2016-05-13 23:14:45', '2019-12-01', 7, NULL, 120, 136, 'N'),
	(307, 'naldinho', '2016-05-13 23:14:45', '2020-01-01', 7, NULL, 120, 136, 'N'),
	(308, 'naldinho', '2016-05-13 23:14:45', '2020-02-01', 7, NULL, 120, 136, 'N'),
	(309, 'mensalidade semestre', '2016-05-14 00:26:10', '2016-06-15', 7, NULL, 95, 122, 'N'),
	(310, 'mensalidade semestre', '2016-05-14 00:26:10', '2016-07-15', 7, NULL, 95, 122, 'N'),
	(311, 'mensalidade semestre', '2016-05-14 00:26:10', '2016-08-15', 7, NULL, 95, 122, 'N'),
	(312, 'mensalidade semestre', '2016-05-14 00:26:10', '2016-09-15', 7, NULL, 95, 122, 'N'),
	(313, 'mensalidade semestre', '2016-05-14 00:26:10', '2016-10-15', 7, NULL, 95, 122, 'N'),
	(314, 'mensalidade semestre', '2016-05-14 00:26:10', '2016-11-15', 7, NULL, 95, 122, 'N');
...
-- Copiando dados para a tabela acadlite.log: ~240 rows (aproximadamente)
DELETE FROM `log`;
...
INSERT INTO `log` (`id`, `cod_usuario`, `computador`, `operacao`, `dt_operacao`) VALUES
	...
	(113, 14, 'BRUNO-PC', 'Login', '2016-05-10 17:42:35'),
	(114, 14, 'BRUNO-PC', 'Logout', '2016-05-10 17:43:08'),
	(115, 14, 'BRUNO-PC', 'Login', '2016-05-11 09:49:18'),
	(116, 14, 'BRUNO-PC', 'Logout', '2016-05-11 09:49:48'),
	(117, 14, 'BRUNO-PC', 'Login', '2016-05-11 09:55:35'),
	(118, 14, 'BRUNO-PC', 'Logout', '2016-05-11 09:55:41'),
	(119, 14, 'BRUNO-PC', 'Login', '2016-05-11 11:59:11'),
	(120, 14, 'BRUNO-PC', 'Logout', '2016-05-11 11:59:18'),
	(121, 14, 'BRUNO-PC', 'Login', '2016-05-11 12:37:25'),
	(122, 14, 'BRUNO-PC', 'Login', '2016-05-11 12:39:34'),
	(123, 14, 'BRUNO-PC', 'Login', '2016-05-11 12:43:04'),
	(124, 14, 'BRUNO-PC', 'Login', '2016-05-11 12:46:23'),
	(125, 14, 'BRUNO-PC', 'Login', '2016-05-11 12:52:06'),
	(126, 14, 'BRUNO-PC', 'Login', '2016-05-11 12:54:38'),
	(127, 14, 'BRUNO-PC', 'Logout', '2016-05-11 12:55:07'),
	(128, 14, 'BRUNO-PC', 'Login', '2016-05-11 12:55:52'),
	(129, 14, 'BRUNO-PC', 'Logout', '2016-05-11 12:58:10'),
	(130, 14, 'BRUNO-PC', 'Login', '2016-05-11 13:02:23'),
	(131, 14, 'BRUNO-PC', 'Login', '2016-05-11 13:04:08'),
	(132, 14, 'BRUNO-PC', 'Logout', '2016-05-11 13:04:32'),
	(133, 14, 'BRUNO-PC', 'Login', '2016-05-11 13:10:53'),
	(134, 14, 'BRUNO-PC', 'Login', '2016-05-11 13:12:50'),
	(135, 14, 'BRUNO-PC', 'Logout', '2016-05-11 13:13:37'),
	(136, 14, 'BRUNO-PC', 'Login', '2016-05-11 13:18:07'),
	(137, 14, 'BRUNO-PC', 'Login', '2016-05-11 13:22:35'),
	(138, 14, 'BRUNO-PC', 'Login', '2016-05-11 13:31:26'),
	(139, 14, 'BRUNO-PC', 'Logout', '2016-05-11 13:31:39'),
	(140, 14, 'BRUNO-PC', 'Login', '2016-05-11 13:42:03'),
	(141, 14, 'BRUNO-PC', 'Login', '2016-05-11 13:42:56'),
	(142, 14, 'BRUNO-PC', 'Logout', '2016-05-11 13:43:01'),
	(143, 14, 'BRUNO-PC', 'Login', '2016-05-11 13:43:28'),
	(144, 14, 'BRUNO-PC', 'Logout', '2016-05-11 13:43:48'),
	(145, 14, 'BRUNO-PC', 'Login', '2016-05-11 13:44:07'),
	(146, 14, 'BRUNO-PC', 'Logout', '2016-05-11 13:44:26'),
	(147, 14, 'BRUNO-PC', 'Login', '2016-05-11 13:44:48'),
	(148, 14, 'BRUNO-PC', 'Login', '2016-05-11 14:21:30'),
	(149, 14, 'BRUNO-PC', 'Login', '2016-05-11 14:23:51'),
	(150, 14, 'BRUNO-PC', 'Logout', '2016-05-11 14:24:55'),
	(151, 14, 'BRUNO-PC', 'Login', '2016-05-11 14:25:43'),
	(152, 14, 'BRUNO-PC', 'Login', '2016-05-11 14:30:55'),
	(153, 14, 'BRUNO-PC', 'Logout', '2016-05-11 14:32:38'),
	(154, 14, 'BRUNO-PC', 'Login', '2016-05-11 15:22:38'),
	(155, 14, 'BRUNO-PC', 'Logout', '2016-05-11 15:23:32'),
	(156, 14, 'BRUNO-PC', 'Login', '2016-05-11 15:25:24'),
	(157, 14, 'BRUNO-PC', 'Login', '2016-05-11 15:27:25'),
	(158, 14, 'BRUNO-PC', 'Login', '2016-05-11 15:28:45'),
	(159, 14, 'BRUNO-PC', 'Logout', '2016-05-11 15:29:13'),
	(160, 14, 'BRUNO-PC', 'Login', '2016-05-11 15:29:55'),
	(161, 14, 'BRUNO-PC', 'Logout', '2016-05-11 15:30:16'),
	(162, 14, 'BRUNO-PC', 'Login', '2016-05-11 15:31:24'),
	(163, 14, 'BRUNO-PC', 'Logout', '2016-05-11 15:32:18'),
	(164, 14, 'BRUNO-PC', 'Login', '2016-05-11 15:32:44'),
	(165, 14, 'BRUNO-PC', 'Logout', '2016-05-11 15:34:34'),
	(166, 14, 'BRUNO-PC', 'Login', '2016-05-11 15:35:56'),
	(167, 14, 'BRUNO-PC', 'Login', '2016-05-11 15:36:34'),
	(168, 14, 'BRUNO-PC', 'Login', '2016-05-11 16:21:33'),
	(169, 14, 'BRUNO-PC', 'Login', '2016-05-12 17:09:01'),
	(170, 14, 'BRUNO-PC', 'Login', '2016-05-12 17:14:05'),
	(171, 14, 'BRUNO-PC', 'Login', '2016-05-12 17:33:20'),
	(172, 14, 'BRUNO-PC', 'Login', '2016-05-12 17:41:22'),
	(173, 14, 'BRUNO-PC', 'Login', '2016-05-12 17:47:22'),
	(174, 14, 'BRUNO-PC', 'Logout', '2016-05-12 17:51:04'),
	(175, 14, 'BRUNO-PC', 'Login', '2016-05-12 17:51:44'),
	(176, 14, 'BRUNO-PC', 'Login', '2016-05-12 17:53:31'),
	(177, 14, 'BRUNO-PC', 'Logout', '2016-05-12 17:53:45'),
	(178, 14, 'BRUNO-PC', 'Login', '2016-05-12 17:54:07'),
	(179, 14, 'BRUNO-PC', 'Logout', '2016-05-12 17:54:15'),
	(180, 14, 'BRUNO-PC', 'Login', '2016-05-12 17:54:39'),
	(181, 14, 'BRUNO-PC', 'Logout', '2016-05-12 17:54:51'),
	(182, 14, 'BRUNO-PC', 'Login', '2016-05-12 17:58:10'),
	(183, 14, 'BRUNO-PC', 'Login', '2016-05-12 18:06:20'),
	(184, 14, 'BRUNO-PC', 'Login', '2016-05-12 18:13:32'),
	(185, 14, 'BRUNO-PC', 'Login', '2016-05-12 18:18:47'),
	(186, 14, 'BRUNO-PC', 'Login', '2016-05-12 18:23:54'),
	(187, 14, 'BRUNO-PC', 'Login', '2016-05-12 18:25:04'),
	(188, 14, 'BRUNO-PC', 'Login', '2016-05-12 18:25:50'),
	(189, 14, 'BRUNO-PC', 'Login', '2016-05-12 22:38:54'),
	(190, 14, 'BRUNO-PC', 'Login', '2016-05-12 22:42:52'),
	(191, 14, 'BRUNO-PC', 'Login', '2016-05-12 22:44:24'),
	(192, 14, 'BRUNO-PC', 'Login', '2016-05-12 22:47:17'),
	(193, 14, 'BRUNO-PC', 'Login', '2016-05-13 00:25:52'),
	(194, 14, 'BRUNO-PC', 'Login', '2016-05-13 00:26:49'),
	(195, 14, 'BRUNO-PC', 'Login', '2016-05-13 00:31:04'),
	(196, 14, 'BRUNO-PC', 'Login', '2016-05-13 00:33:24'),
	(197, 14, 'BRUNO-PC', 'Login', '2016-05-13 00:35:27'),
	(198, 14, 'BRUNO-PC', 'Login', '2016-05-13 00:38:11'),
	(199, 14, 'BRUNO-PC', 'Login', '2016-05-13 08:28:15'),
	(200, 14, 'BRUNO-PC', 'Login', '2016-05-13 10:34:41'),
	(201, 14, 'BRUNO-PC', 'Login', '2016-05-13 10:58:07'),
	(202, 14, 'BRUNO-PC', 'Login', '2016-05-13 11:02:17'),
	(203, 14, 'BRUNO-PC', 'Login', '2016-05-13 12:57:26'),
	(204, 14, 'BRUNO-PC', 'Logout', '2016-05-13 12:59:30'),
	(205, 14, 'BRUNO-PC', 'Login', '2016-05-13 13:02:29'),
	(206, 14, 'BRUNO-PC', 'Login', '2016-05-13 13:04:49'),
	(207, 14, 'BRUNO-PC', 'Login', '2016-05-13 13:23:27'),
	(208, 14, 'BRUNO-PC', 'Login', '2016-05-13 13:25:59'),
	(209, 14, 'BRUNO-PC', 'Login', '2016-05-13 13:27:36'),
	(210, 14, 'BRUNO-PC', 'Login', '2016-05-13 13:28:50'),
	(211, 14, 'BRUNO-PC', 'Login', '2016-05-13 13:37:45'),
	(212, 14, 'BRUNO-PC', 'Login', '2016-05-13 13:51:15'),
	(213, 14, 'BRUNO-PC', 'Login', '2016-05-13 14:05:26'),
	(214, 14, 'BRUNO-PC', 'Login', '2016-05-13 15:24:37'),
	(215, 14, 'BRUNO-PC', 'Login', '2016-05-13 15:27:34'),
	(216, 14, 'BRUNO-PC', 'Login', '2016-05-13 15:30:17'),
	(217, 14, 'BRUNO-PC', 'Login', '2016-05-13 15:33:33'),
	(218, 14, 'BRUNO-PC', 'Login', '2016-05-13 15:36:10'),
	(219, 14, 'BRUNO-PC', 'Login', '2016-05-13 15:39:31'),
	(220, 14, 'BRUNO-PC', 'Login', '2016-05-13 15:48:11'),
	(221, 14, 'BRUNO-PC', 'Login', '2016-05-13 15:51:13'),
	(222, 14, 'BRUNO-PC', 'Login', '2016-05-13 17:11:44'),
	(223, 14, 'BRUNO-PC', 'Login', '2016-05-13 21:55:22'),
	(224, 14, 'BRUNO-PC', 'Login', '2016-05-13 21:55:57'),
	(225, 14, 'BRUNO-PC', 'Login', '2016-05-13 21:57:27'),
	(226, 14, 'BRUNO-PC', 'Logout', '2016-05-13 21:57:55'),
	(227, 14, 'BRUNO-PC', 'Login', '2016-05-13 21:58:01'),
	(228, 14, 'BRUNO-PC', 'Login', '2016-05-13 21:58:42'),
	(229, 14, 'BRUNO-PC', 'Logout', '2016-05-13 21:59:03'),
	(230, 14, 'BRUNO-PC', 'Login', '2016-05-13 22:00:35'),
	(231, 14, 'BRUNO-PC', 'Logout', '2016-05-13 22:01:06'),
	(232, 14, 'BRUNO-PC', 'Login', '2016-05-13 22:13:30'),
	(233, 14, 'BRUNO-PC', 'Login', '2016-05-13 22:30:51'),
	(234, 14, 'BRUNO-PC', 'Login', '2016-05-13 22:32:07'),
	(235, 14, 'BRUNO-PC', 'Login', '2016-05-13 22:36:40'),
	(236, 14, 'BRUNO-PC', 'Login', '2016-05-13 23:03:25'),
	(237, 14, 'BRUNO-PC', 'Login', '2016-05-13 23:07:37'),
	(238, 14, 'BRUNO-PC', 'Login', '2016-05-13 23:14:16'),
	(239, 14, 'BRUNO-PC', 'Login', '2016-05-13 23:59:23'),
	(240, 14, 'BRUNO-PC', 'Logout', '2016-05-14 00:00:09'),
	(241, 14, 'BRUNO-PC', 'Login', '2016-05-14 00:01:29'),
	(242, 14, 'BRUNO-PC', 'Logout', '2016-05-14 00:03:29'),
	(243, 14, 'BRUNO-PC', 'Login', '2016-05-14 00:05:09'),
	(244, 14, 'BRUNO-PC', 'Login', '2016-05-14 00:16:25'),
	(245, 14, 'BRUNO-PC', 'Login', '2016-05-14 00:18:55'),
	(246, 14, 'BRUNO-PC', 'Login', '2016-05-14 00:24:27');
...
CREATE TABLE IF NOT EXISTS `mensalidades` (
  ...
  `cod_agrupamento` int(11) DEFAULT NULL,
  `cod_forma_pagamento` int(11) DEFAULT NULL,
  PRIMARY KEY (`cod_mensalidade`),
  KEY `fk_cod_aluno_mens` (`cod_aluno`),
  KEY `fk_cod_plano` (`cod_plano`),
  KEY `fk_cod_agrupamento` (`cod_agrupamento`),
  KEY `fk_cod_forma_pag` (`cod_forma_pagamento`),
  CONSTRAINT `fk_cod_agrupamento` FOREIGN KEY (`cod_agrupamento`) REFERENCES `agrupamento_mensalidade` (`cod_agrupamento`),
  CONSTRAINT `fk_cod_aluno_mens` FOREIGN KEY (`cod_aluno`) REFERENCES `pessoas` (`cod_pessoa`),
  CONSTRAINT `fk_cod_forma_pag` FOREIGN KEY (`cod_forma_pagamento`) REFERENCES `formas_pagamento` (`id`),
  CONSTRAINT `fk_cod_plano` FOREIGN KEY (`cod_plano`) REFERENCES `planos` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=128 DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela acadlite.mensalidades: ~100 rows (aproximadamente)
DELETE FROM `mensalidades`;
/*!40000 ALTER TABLE `mensalidades` DISABLE KEYS */;
INSERT INTO `mensalidades` (`cod_mensalidade`, `descricao`, `cod_aluno`, `dt_cadastro`, `dt_vencimento`, `dt_recebimento`, `valor`, `valor_recebido`, `cod_plano`, `cod_agrupamento`, `cod_forma_pagamento`) VALUES
	(109, 'Mensalidade para 30 dias', 38, '2016-05-14 00:24:55', '2016-05-15', NULL, 110, 0, 4, 20, NULL),
	(110, 'Mensalidade para um ano', 74, '2016-05-14 00:25:23', '2016-05-16', NULL, 75, 0, 5, 21, NULL),
	(111, 'Mensalidade para um ano', 74, '2016-05-14 00:25:23', '2016-06-16', NULL, 75, 0, 5, 21, NULL),
	(112, 'Mensalidade para um ano', 74, '2016-05-14 00:25:23', '2016-07-16', NULL, 75, 0, 5, 21, NULL),
	(113, 'Mensalidade para um ano', 74, '2016-05-14 00:25:23', '2016-08-16', NULL, 75, 0, 5, 21, NULL),
	(114, 'Mensalidade para um ano', 74, '2016-05-14 00:25:23', '2016-09-16', NULL, 75, 0, 5, 21, NULL),
	(115, 'Mensalidade para um ano', 74, '2016-05-14 00:25:24', '2016-10-16', NULL, 75, 0, 5, 21, NULL),
	(116, 'Mensalidade para um ano', 74, '2016-05-14 00:25:24', '2016-11-16', NULL, 75, 0, 5, 21, NULL),
	(117, 'Mensalidade para um ano', 74, '2016-05-14 00:25:24', '2016-12-16', NULL, 75, 0, 5, 21, NULL),
	(118, 'Mensalidade para um ano', 74, '2016-05-14 00:25:24', '2017-01-16', NULL, 75, 0, 5, 21, NULL),
	(119, 'Mensalidade para um ano', 74, '2016-05-14 00:25:24', '2017-02-16', NULL, 75, 0, 5, 21, NULL),
	(120, 'Mensalidade para um ano', 74, '2016-05-14 00:25:24', '2017-03-16', NULL, 75, 0, 5, 21, NULL),
	(121, 'Mensalidade para um ano', 74, '2016-05-14 00:25:24', '2017-04-16', NULL, 75, 0, 5, 21, NULL),
	(122, 'mensalidade semestre', 78, '2016-05-14 00:25:48', '2016-06-15', '2016-05-14 00:26:10', 95, 95, 1, 22, 4),
	(123, 'mensalidade semestre', 78, '2016-05-14 00:25:48', '2016-07-15', '2016-05-14 00:26:10', 95, 95, 1, 22, 4),
	(124, 'mensalidade semestre', 78, '2016-05-14 00:25:48', '2016-08-15', '2016-05-14 00:26:10', 95, 95, 1, 22, 4),
	(125, 'mensalidade semestre', 78, '2016-05-14 00:25:48', '2016-09-15', '2016-05-14 00:26:10', 95, 95, 1, 22, 4),
	(126, 'mensalidade semestre', 78, '2016-05-14 00:25:48', '2016-10-15', '2016-05-14 00:26:10', 95, 95, 1, 22, 4),
	(127, 'mensalidade semestre', 78, '2016-05-14 00:25:48', '2016-11-15', '2016-05-14 00:26:10', 95, 95, 1, 22, 4);
/*!40000 ALTER TABLE `mensalidades` ENABLE KEYS */;


-- Copiando estrutura para tabela acadlite.pais
...
-- Copiando dados para a tabela acadlite.pais: ~0 rows (aproximadamente)
DELETE FROM `pais`;
...
INSERT INTO `pessoas` (`cod_pessoa`, `nome`, `dt_nascimento`, `cpf`, `telefone`, `celular`, `tipo`, `dt_cadastro`, `logradouro`, `complemento`, `cep`, `bairro`, `cod_cidade`, `cod_uf`) VALUES
	...
	(41, 'Hashim', '2015-12-15', NULL, '1676102015399', NULL, 'Aluno', '2016-05-06 23:49:50', NULL, NULL, NULL, NULL, 222, 3),
	...
	(57, 'Anthony', '2015-11-15', NULL, '1692012831599', NULL, 'Comum', '2016-05-06 23:49:50', 'Campus Universitário Darcy Ribeiro', '', '70910-900', 'Asa Norte', 882, 7),
	...
	(103, 'Abel', '2005-09-16', NULL, '1633073094799', NULL, 'Comum', '2016-05-06 23:49:50', 'Rua Dona Stela', '', '74650-100', 'Setor Negrão de Lima', 698, 6),
...
-- Copiando estrutura para tabela acadlite.planos
CREATE TABLE IF NOT EXISTS `planos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `descricao` varchar(50) NOT NULL DEFAULT '0',
  `dt_cadastro` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `valor` double NOT NULL,
  `num_meses` int(11) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela acadlite.planos: ~3 rows (aproximadamente)
DELETE FROM `planos`;
/*!40000 ALTER TABLE `planos` DISABLE KEYS */;
INSERT INTO `planos` (`id`, `descricao`, `dt_cadastro`, `valor`, `num_meses`) VALUES
	(1, 'Plano Semestral', '2016-05-14 00:14:29', 95, 6),
	(2, 'plano de 8 meses', '2016-05-12 17:10:40', 80, 8),
	(3, 'plano bimestral', '2016-05-12 22:40:09', 100, 2),
	(4, 'Plano Mensal', '2016-05-13 00:33:48', 110, 1),
	(5, 'plano Anual', '2016-05-13 15:54:33', 75, 12);
